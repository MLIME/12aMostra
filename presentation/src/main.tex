...
%O Overleaf não deixa eu criar mais files.+++++++++++++++++++++++++++++
% A imagem do frame abaixo deve ser colocada
% no arquivo "batch_example_values.tex"
% e no lugar no frame deve haver apenas o
% comando \input{TikzFiles/batch_example_values}
...
%O Overleaf não deixa eu criar mais files.+++++++++++++++++++++++++++++
% A imagem do frame abaixo deve ser colocada
% no arquivo "batch_graph.tex"
% e no lugar no frame deve haver apenas o
% comando \input{TikzFiles/batch_graph}
...
\Large{
\begin{align*}
{b_1}^{novo} &= {b_1}^{velho} - \alpha \frac{\partial L}{\partial b_1}\\
&= 0 + \alpha 0.19\\
\end{align*}
}
\end{frame}
